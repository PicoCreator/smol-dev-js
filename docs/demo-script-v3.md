What do the following pokedex and Google Chrome plugin have in common? They are both fully generated by AI. And now, you can do the same using just plain language.
